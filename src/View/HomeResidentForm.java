 ...
 * @author DELL
 */
public class HomeResidentForm extends javax.swing.JFrame {
    ...
    public HomeResidentForm(String residentId) {
...
//--------------------------------------------------------------------------------FACILITY------------------------------------------------------
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HomeResidentForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
