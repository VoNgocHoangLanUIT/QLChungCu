 ...
 * @author DELL
 */
public class AddParkingForm extends javax.swing.JDialog {
    /**
    ...
    private void initComponents() {
        ...
        addParkingSlotButton.setBackground(new java.awt.Color(0, 153, 0));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(vehicleField, javax.swing.GroupLayout.DEFAULT_SIZE, 47, Short.MAX_VALUE))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(licensePlateField, javax.swing.GroupLayout.DEFAULT_SIZE, 47, Short.MAX_VALUE))
                .addGap(29, 29, 29)
    ...
    private void addParkingSlotButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addParkingSlotButtonActionPerformed
        ...
        ParkingSlot newSlot = new ParkingSlot(slotNameText, slotTypeText, vehicleText, statusText, licensePlateText);

        // Gọi service để thêm
        int result = parkingService.addParkingSlot(newSlot);
        
        if (result > 0) {
            JOptionPane.showMessageDialog(this, "Add parking slot successful!");
        } else {
            JOptionPane.showMessageDialog(this, "Add parking slot failed!", "Error", JOptionPane.ERROR_MESSAGE);
        }
